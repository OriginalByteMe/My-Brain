...
MODEL_IDS: str = ["llama3:8b", "mistral", "starcoder2:3b"]
...
image = (
    ...
    .copy_local_file("./app/entrypoint.sh", "/opt/entrypoint.sh")
    .dockerfile_commands(
        [
...
ollama_app = modal.App("ollama-server", image=image)
...
@ollama_app.function(gpu="T4", allow_concurrent_inputs=10, concurrency_limit=1)
@modal.asgi_app()
def ollama_api():
    return app
